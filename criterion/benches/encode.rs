...
use jpeg_encoder::{ColorType, DefaultBitStream, Encoder, SamplingFactor};
...
fn encode_rgb_optimized(res: &mut Vec<u8>, data: &[u8], width: u16, height: u16) {
    let mut encoder = Encoder::new(DefaultBitStream::new(res), 100);
